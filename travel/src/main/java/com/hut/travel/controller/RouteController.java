...
public class RouteController {
    ...
    @ResponseBody
    public Object uploadImg(@RequestParam("routeId") Integer routeId, @RequestParam("file") MultipartFile file, HttpServletRequest request){
        HashMap<String,String> addResult = new HashMap<String, String>();
        String newFilename = "";
        try {
            newFilename = UploadFileUtils.uploadImgFile(file,request,"rp");
        } catch (IOException e) {
            e.printStackTrace();
        }
        String sqlFilename;
