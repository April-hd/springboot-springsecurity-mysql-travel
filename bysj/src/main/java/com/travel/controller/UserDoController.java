...
import com.travel.service.UserDoService;
...
public class UserDoController {
    ...
    @ResponseBody
    public Object updateHeaderImg(@RequestParam("file") MultipartFile file,HttpSession session) throws IOException {
        HashMap<String,String> updateResult = new HashMap<String, String>();
        //1.通过上传文件工具类，进行文件的上传以及备份，并返回生成的文件名
        String newFilename = UploadFileUtils.uploadImgFile(file,"header");
        //2.获取当前登录用户的id
